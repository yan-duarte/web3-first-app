...
const ServiceCard = ({ color, title, icon, subtitle }: ServiceCardInterface) => (
  <div className="flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-point hover:shadow-sl">
    ...
    <div className="ml-5 flex flex-1 flex-col text-white">
      ...
      <p className="m-2 text-sm md:w-9/12">{subtitle}</p>
    </div>
  </div>
);
